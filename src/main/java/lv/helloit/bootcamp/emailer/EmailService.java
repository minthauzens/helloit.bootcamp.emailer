...
public class EmailService {
    public static final String FROM = "sweeter@mmm.id.lv";
    ...
    public boolean sendEmail(SendEmailRequestDto requestDto) throws SparkPostException {
        if (!enabled) {
            return false;
        }
        client.sendMessage(
                FROM,
                requestDto.getEmailTo(),
